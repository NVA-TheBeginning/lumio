...
import { PresentationOrdersDialog } from "@/components/projects/presentations/presentation-orders-dialog";
...
export function ProjectPresentations({ project }: ProjectPresentationsProps) {
  ...
  const handleManageOrders = (presentation: PresentationType) => {
    setSelectedPresentation(presentation);
  ...
  const getActivePromotion = () => {
    return project.promotions.find((p) => p.id.toString() === activePromotion);
  };
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem onClick={() => handleManageOrders(presentation)}>
                          ...
                          <CardContent>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Badge variant="outline">{promotion.groups.length} groupes</Badge>
                              </div>
                            </div>
                          </CardContent>
                        </Card>
